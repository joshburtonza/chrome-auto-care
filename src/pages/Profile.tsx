...
const Profile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    address: "123 Performance Drive, Los Angeles, CA 90210",
  });
        ...
        <ChromeSurface className="p-8 mb-6" glow>
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-light text-foreground mb-1">{profile.name}</h2>
                <div className="chrome-label text-[10px] text-text-tertiary">CLIENT SINCE MARCH 2024</div>
              </div>
            </div>
            <ChromeButton
