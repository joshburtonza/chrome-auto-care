...
import { Package, Store, ShoppingBag, LogOut, MoreHorizontal, Boxes, Ticket, Image, UserCircle, Users, FileText } from 'lucide-react';
...
export const MobileStaffNav = () => {
  ...
  const moreItems = [
    ...
    ...(isAdmin ? [{ path: '/staff/process-templates', label: 'Process Templates', icon: FileText }] : []),
