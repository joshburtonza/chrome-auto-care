...
export const MobileNav = () => {
  ...
  return (
    <nav className="bg-card/90 backdrop-blur-xl border-b border-border/30 sticky top-0 z-50 md:hidden">
      <div className="px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-1">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="w-[280px] p-0 bg-card border-border/30">
                    ...
                    {navItems.map((item) => {
                      ...
                      return (
                        <SheetClose asChild key={item.path}>
                          <Link
                            to={item.path}
                            className={`flex items-center gap-3 px-5 py-3 text-sm transition-all relative ${
                              isActive 
